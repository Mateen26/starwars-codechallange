...
const DetailsPage = () => {
  const { selectedData, selectedCharacter, loading } = useDataContext();
                ...
                <div class="">
                  ...
                  <div class="panel-body bio-graph-info card card-background">
                    <div class="row ms-3 mt-2">
                      ...
                      <div class="bio-row">
                        <p>
                          <span className="profile-data-heading">Height </span>:{" "}
                      ...
                      <div class="bio-row">
                        ...
                        <p>
                          {selectedData?.shipData?.map((e, index) => (
                            <span key={e.name} className="styling-ship-details">
                              <b>Name:</b> {e.name}&nbsp; <br />
                              <b>Cargo Capacity:</b> {e.cargo_capacity} <br />
                              ...
                              <b>Crew:</b> {e.crew}
                              <br />
                              <b>Hyperdrive_rating:</b> {e.hyperdrive_rating}
                              <br />
                              <b>Length:</b> {e.length}
                              <br />
